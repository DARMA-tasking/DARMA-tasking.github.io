...
\hypertarget{ckpt_learn_ex1_nonintrusive}{}\label{ckpt_learn_ex1_nonintrusive}\index{Non-\/Intrusive Program Example 1@{Non-\/Intrusive Program Example 1}}
\begin{DoxyAttention}{Attention}
All Non-\/\+Intrusive serialize methods {\bfseries{MUST}} be placed in the namespace of type which they serialize.
\end{DoxyAttention}
The full code for this {\itshape magistrate} example can be found here:\+ {\ttfamily examples/\+checkpoint\+\_\+example\+\_\+1\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex1_nonintrusive_ex1}{}\doxysubsubsection{\texorpdfstring{Example source code:\+}{Example source code:\+}}\label{ckpt_learn_ex1_nonintrusive_ex1}
...
\DoxyCodeLine{\textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespacecheckpoint}{checkpoint}}\ \{\ \textcolor{keyword}{namespace\ }nonintrusive\ \{\ \textcolor{keyword}{namespace\ }examples\ \{}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \textcolor{keywordtype}{void}\ \doxymbox{\hyperlink{namespacecheckpoint_a3ae835131252c03a5e8eddde3bbc0f12}{serialize}}(Serializer\&\ s,\ MyTest3\&\ my\_test3)\ \{}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ ret\ =\ \doxymbox{\hyperlink{namespacecheckpoint_a3ae835131252c03a5e8eddde3bbc0f12}{checkpoint::serialize}}(my\_test3);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ t\ =\ \doxymbox{\hyperlink{namespacecheckpoint_aabc60718e6a3208fa8cb7b5de4c55087}{checkpoint::deserialize<MyTest3>}}(buf);}
\DoxyCodeLine{}
