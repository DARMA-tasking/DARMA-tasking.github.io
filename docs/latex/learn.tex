...
{\ttfamily U\+S\+E\+\_\+\+O\+P\+E\+N\+MP} &0 &Force use of Open\+MP for threading \\\cline{1-3}
{\ttfamily U\+S\+E\+\_\+\+S\+T\+D\+\_\+\+T\+H\+R\+E\+AD} &0 &Force use of std\+::thread for threading \\\cline{1-3}
...
{\ttfamily V\+T\+\_\+\+U\+S\+E\+\_\+\+O\+P\+E\+N\+MP} &0 &Force use of Open\+MP for threading \\\cline{1-3}
{\ttfamily V\+T\+\_\+\+U\+S\+E\+\_\+\+S\+T\+D\+\_\+\+T\+H\+R\+E\+AD} &0 &Force use of std\+::thread for threading \\\cline{1-3}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv) \{
  MPI\_Init(&argc, &argv);
  \hyperlink{namespacevt_aae6ab5af3e11886ce73c4c3ffa008201}{vt::initialize}(argc, argv, &MPI\_COMM\_WORLD);
   \textcolor{comment}{// program here}
  \hyperlink{namespacevt_a540d90dbd6e97b69f1dcbc9ee9314cff}{vt::finalize}();
  MPI\_Finalize();
\}
...
If, for any reason, you want to predefine configuration, you can do it by creating {\ttfamily App\+Config} object, setting its members as you wish, and passing it to {\ttfamily \hyperlink{namespacevt_aae6ab5af3e11886ce73c4c3ffa008201}{vt\+::initialize}}\+:
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv) \{
  ...
  appConfig.vt\_lb\_stats = \textcolor{keyword}{true};

  \hyperlink{namespacevt_aae6ab5af3e11886ce73c4c3ffa008201}{vt::initialize}(argc, argv, &appConfig);
   \textcolor{comment}{// program here}
  \hyperlink{namespacevt_a540d90dbd6e97b69f1dcbc9ee9314cff}{vt::finalize}();
\}
\end{DoxyCode}
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv) \{
  ...
  \hyperlink{namespacevt_aae6ab5af3e11886ce73c4c3ffa008201}{vt::initialize}(argc, argv, &MPI\_COMM\_WORLD, &appConfig);
   \textcolor{comment}{// program here}
  \hyperlink{namespacevt_a540d90dbd6e97b69f1dcbc9ee9314cff}{vt::finalize}();
  MPI\_Finalize();
\}
...
It is worth noting that if you run your application with any of vt\textquotesingle{}s command-\/line arguments and at the same time you define and pass {\ttfamily App\+Config} to {\ttfamily \hyperlink{namespacevt_aae6ab5af3e11886ce73c4c3ffa008201}{vt\+::initialize}}, C\+LI arguments have a higher priority. In other words, if you predefine in source code and give from the command line the same vt\textquotesingle{}s argument, but with a different value, the program will use the C\+LI one.
