...
For {\ttfamily docker-\/compose}, the following variables can be set to configure the build. One may configure the architecture, compiler type and version, Linux distro (ubuntu or alpine), and distro version.
...
# Variables:
#   ARCH=\{amd64, arm64v8, ...\}
#   COMPILER\_TYPE=\{gnu, clang, intel\}
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<MyMsg,msgHandlerA>(to\_node, msg.get());
  \}
\}
...
\textcolor{comment}{   */}
  ...
  \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<MsgHandlerB>(to\_node, msg2.get());
\}
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<ParticleMsg,msgSerialA>(to\_node, msg.get());
  \}
\}
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__typesafehan_ga4a7106231ba8a26a1214a6f133e381eb}{broadcastMsg}<MyDataMsg,msgHandlerX>(msg.get());
  \}
\}
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \textcolor{keyword}{auto} \textcolor{keywordtype}{id} = \hyperlink{namespacevt_a4548473dce44fb654400009e2b2fe64e}{theGroup}()->\hyperlink{structvt_1_1group_1_1_group_manager_aaf9941faced23021a420185203219149}{newGroup}(std::move(range), [](
      ...
      \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{theMsg}()->\hyperlink{group__typesafehan_ga4a7106231ba8a26a1214a6f133e381eb}{broadcastMsg}<MySimpleMsg,msgHandlerGroupA>(msg.get());
    \});
  ...
  \textcolor{keyword}{auto} group = \hyperlink{namespacevt_a4548473dce44fb654400009e2b2fe64e}{theGroup}()->\hyperlink{structvt_1_1group_1_1_group_manager_a92b301d6cf77af7d57ed822c6f044d58}{newGroupCollective}(
    is\_even\_node, [](\hyperlink{namespacevt_a27b5e4411c9b6140c49100e050e2f743}{GroupType} group\_id)\{
      ...
      \textcolor{keywordflow}{if} (my\_node == 1) \{
        ...
        \hyperlink{namespacevt_a9f9d4ce6034c0eaaf98bdffd33d0e1c7}{envelopeSetGroup}(msg->env, group\_id);
        \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{theMsg}()->\hyperlink{group__typesafehan_ga4a7106231ba8a26a1214a6f133e381eb}{broadcastMsg}<MySimpleMsg2,msgHandlerGroupB>(msg.get());
      \}
    \}
  );
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \{
      \textcolor{keyword}{auto} cb = \hyperlink{namespacevt_a673b109e94c7bca58313504c83e1da94}{::vt::theCB}()->\hyperlink{structvt_1_1pipe_1_1_pipe_manager_adb73a299b634a180ae3814b41b9ce255}{makeFunc}(void\_fn);
      \textcolor{keyword}{auto} msg = ::vt::makeMessage<MsgWithCallback>(cb);
      \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<MsgWithCallback,getCallbackHandler>(to\_node,msg.get());
    \}
    ...
    \{
      \textcolor{keyword}{auto} cb = \hyperlink{namespacevt_a673b109e94c7bca58313504c83e1da94}{::vt::theCB}()->\hyperlink{structvt_1_1pipe_1_1_pipe_manager_adb73a299b634a180ae3814b41b9ce255}{makeFunc}<DataMsg,MyContext>(&
      \hyperlink{namespacevt_1_1config_a0551245b6b893932b95aaf8eac94eed1}{ctx}, callbackCtx);
      \textcolor{keyword}{auto} msg = ::vt::makeMessage<MsgWithCallback>(cb);
      \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<MsgWithCallback,getCallbackHandler>(to\_node,msg.get());
    \}
  \}
...
\textcolor{comment}{   */}
  ...
  \hyperlink{namespacevt_aa8e0c0ab253e7ad1acd5d09e36fea769}{::vt::theCollective}()->\hyperlink{structvt_1_1collective_1_1reduce_1_1_reduce_manager_afa3c814ff0e1c7ef1a9f76ed4036512b}{global}()->\hyperlink{structvt_1_1collective_1_1reduce_1_1_reduce_ac41b433147b957df5639d72ac8946090}{reduce}<ReduceOp,ReduceResult>(
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \textcolor{comment}{// invoked on every element to the collection}
    \textcolor{keyword}{auto} msg = ::vt::makeMessage<ColRedMsg>();
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<ExampleMsg,recurHandler>(this\_node+1,msg.get());
  \}
...
\textcolor{keyword}{static} \textcolor{keywordtype}{void} recurHandler(ExampleMsg* msg) \{
  ...
  \textcolor{keywordflow}{if} (msg->ttl > 0) \{
    ...
    \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} i = 0; i < num\_send; i++) \{
      ...
      \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{vt::theMsg}()->\hyperlink{group__preregister_gaebfcd932babb3be0ea8d481f655a2835}{sendMsg}<ExampleMsg,recurHandler>(next\_node,msg\_send.get());
    \}
  \}
\}
\end{DoxyCodeInclude}
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keywordtype}{void} checkCompleteCB(ReduxMsg* msg) \{
    ...
    \textcolor{keywordflow}{if} ((iter <= maxIter) and (normRes >= default\_tol)) \{
      ...
      \textcolor{comment}{//}
      \textcolor{keyword}{auto} proxy = getCollectionProxy();
      \textcolor{keyword}{auto} loopMsg = vt::makeMessage<BlankMsg>();
  ...
  \textcolor{keywordtype}{void} sendInfo(BlankMsg *msg) \{
    ...
    \textcolor{keywordflow}{if} (myIdx > 0) \{
      \textcolor{keyword}{auto} leftMsg = vt::makeMessage<VecMsg>(myIdx, told\_[1]);
    ...
    \textcolor{keywordflow}{if} (\textcolor{keywordtype}{size\_t}(myIdx) < numObjs\_ - 1) \{
      \textcolor{keyword}{auto} rightMsg = vt::makeMessage<VecMsg>(myIdx, told\_[numRowsPerObject\_]);
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv) \{
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \textcolor{keyword}{auto} rootMsg = vt::makeMessage<LinearPb1DJacobi::LPMsg>(
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keywordtype}{void} sendInfo(BlankMsg *msg) \{
    ...
    \textcolor{keywordflow}{if} (x > 0) \{
      ...
      \textcolor{keyword}{auto} leftX = vt::makeMessage<VecMsg>(idx, tcopy);
    ...
    \textcolor{keywordflow}{if} (y > 0) \{
      ...
      \textcolor{keyword}{auto} bottomY = vt::makeMessage<VecMsg>(idx, tcopy);
    ...
    \textcolor{keywordflow}{if} (\textcolor{keywordtype}{size\_t}(x) < numObjsX\_ - 1) \{
      ...
      \}
      \textcolor{keyword}{auto} rightX = vt::makeMessage<VecMsg>(idx, tcopy);
    ...
    \textcolor{keywordflow}{if} (\textcolor{keywordtype}{size\_t}(y) < numObjsY\_ - 1) \{
      ...
      \textcolor{keyword}{auto} topY = vt::makeMessage<VecMsg>(idx, tcopy);
...
\textcolor{keywordtype}{int} main(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char}** argv) \{
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \textcolor{keyword}{auto} rootMsg = vt::makeMessage<LinearPb2DJacobi::LPMsg>(
      numX\_objs,
      numY\_objs,
      maxIter
    );
