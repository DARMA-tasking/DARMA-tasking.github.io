...
#   VT\_CODE\_COVERAGE=0           # Enable generation of code coverage reports
...
\textcolor{comment}{// Message handler}
\textcolor{keyword}{static} \textcolor{keywordtype}{void} msgHandlerGroupA([[maybe\_unused]] MySimpleMsg* msg) \{
  \textcolor{keyword}{auto} \textcolor{keyword}{const} cur\_node = \hyperlink{namespacevt_a26551fe0e6e6a1371111df5b12c7e92c}{::vt::theContext}()->\hyperlink{structvt_1_1ctx_1_1_context_a0d52c263ce8516546a67443d9a86fa5f}{getNode}();
...
\textcolor{comment}{// Message handler}
\textcolor{keyword}{static} \textcolor{keywordtype}{void} msgHandlerGroupB([[maybe\_unused]] MySimpleMsg2* msg) \{
  \textcolor{keyword}{auto} \textcolor{keyword}{const} cur\_node = \hyperlink{namespacevt_a26551fe0e6e6a1371111df5b12c7e92c}{::vt::theContext}()->\hyperlink{structvt_1_1ctx_1_1_context_a0d52c263ce8516546a67443d9a86fa5f}{getNode}();
...
\textcolor{comment}{// Forward declaration for the active message handler}
\textcolor{keyword}{static} \textcolor{keywordtype}{void} getCallbackHandler(Callback<int> cb);

\textcolor{comment}{// An active message handler used as the target for a callback}
\textcolor{keyword}{static} \textcolor{keywordtype}{void} callbackHandler(\textcolor{keywordtype}{int} data) \{
  ...
  ::fmt::print(\textcolor{stringliteral}{"\{\}: triggering active message callback: \{\}\(\backslash\)n"}, cur\_node, data);
\}

\textcolor{comment}{// An active message handler used as the target for a callback}
\textcolor{keyword}{static} \textcolor{keywordtype}{void} callbackBcastHandler(\textcolor{keywordtype}{int} data) \{
  \hyperlink{namespacevt_a866da9d0efc19c0a1ce79e9e492f47e2}{NodeType} \textcolor{keyword}{const} cur\_node = \hyperlink{namespacevt_a26551fe0e6e6a1371111df5b12c7e92c}{::vt::theContext}()->\hyperlink{structvt_1_1ctx_1_1_context_a0d52c263ce8516546a67443d9a86fa5f}{getNode}();
  ::fmt::print(
    \textcolor{stringliteral}{"\{\}: triggering active message callback bcast: \{\}\(\backslash\)n"}, cur\_node, data
  );
\}
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    ...
    \{
      \textcolor{keyword}{auto} cb = \hyperlink{namespacevt_a673b109e94c7bca58313504c83e1da94}{::vt::theCB}()->\hyperlink{structvt_1_1pipe_1_1_pipe_manager_a3c6313a04c8ba283f4c32986ff8c7c30}{makeSend}<callbackHandler>(cb\_node);
      \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__typesafehan_ga4557b5ce74c8c5df0013cf49738517bf}{send}<getCallbackHandler>(\hyperlink{namespacevt_a04777c732e1a2b2c317995af9972b999}{Node}\{to\_node\}, cb);
    \}

    \textcolor{comment}{// Example of active message handler callback with broadcast}
    \{
      \textcolor{keyword}{auto} cb = \hyperlink{namespacevt_a673b109e94c7bca58313504c83e1da94}{::vt::theCB}()->\hyperlink{structvt_1_1pipe_1_1_pipe_manager_a5b124c9c765e8b3bb9aca1b367e45db2}{makeBcast}<callbackBcastHandler>();
      \hyperlink{namespacevt_aeafd31f866aeb4dc6fc2f6ee97136350}{::vt::theMsg}()->\hyperlink{group__typesafehan_ga4557b5ce74c8c5df0013cf49738517bf}{send}<getCallbackHandler>(\hyperlink{namespacevt_a04777c732e1a2b2c317995af9972b999}{Node}\{to\_node\}, cb);
    \}
  \}
\}
...
\textcolor{keyword}{static} \textcolor{keywordtype}{void} getCallbackHandler(Callback<int> cb) \{
  ...
  cb.send(29 + cur\_node);
\}
\end{DoxyCodeInclude}
\hypertarget{tutorial-1h}{}\subsection{Learning about reductions}\label{tutorial-1h}

\begin{DoxyCodeInclude}
\textcolor{keywordtype}{void} reduceResult(\textcolor{keywordtype}{int} result) \{
  \hyperlink{namespacevt_a866da9d0efc19c0a1ce79e9e492f47e2}{NodeType} \textcolor{keyword}{const} num\_nodes = \hyperlink{namespacevt_a26551fe0e6e6a1371111df5b12c7e92c}{::vt::theContext}()->
      \hyperlink{structvt_1_1ctx_1_1_context_a7f41071aadf6d5fa9e1b6c703c5ff19d}{getNumNodes}();
  (void)num\_nodes;  \textcolor{comment}{// don't warn about possibly unused variable}
  fmt::print(\textcolor{stringliteral}{"reduction value=\{\}\(\backslash\)n"}, result);
  assert(num\_nodes * 50 == result);
\}
...
\textcolor{comment}{   */}
  ...
  \textcolor{keyword}{auto} r = \hyperlink{namespacevt_aa8e0c0ab253e7ad1acd5d09e36fea769}{vt::theCollective}()->\hyperlink{structvt_1_1collective_1_1reduce_1_1_reduce_manager_afa3c814ff0e1c7ef1a9f76ed4036512b}{global}();
  r->\hyperlink{structvt_1_1collective_1_1reduce_1_1_reduce_adf8bd9748a220a3ed29087c30f8adafc}{reduce}<reduceResult, \hyperlink{namespacevt_1_1collective_a7a695a8e6ed8247f643918113b7bf881}{collective::PlusOp}>(\hyperlink{structvt_1_1util_1_1strong_1_1detail_1_1_strong}{vt::Node}\{root\_reduce\_node\}, 
      50);
\}
\end{DoxyCodeInclude}
...
\textcolor{keywordtype}{void} MyCol::msgHandler([[maybe\_unused]] MyCollMsg* msg) \{
...
\textcolor{keyword}{struct }ReduceCol : \hyperlink{structvt_1_1vrt_1_1collection_1_1_collection}{::vt::Collection}<ReduceCol,Index1D> \{
  ...
  \textcolor{keywordtype}{void} reduceHandler();
  \textcolor{keywordtype}{void} reduceTarget(\textcolor{keywordtype}{int} value);
...
\textcolor{keywordtype}{void} ReduceCol::reduceHandler() \{
  \textcolor{keyword}{auto} cur\_node = \hyperlink{namespacevt_a26551fe0e6e6a1371111df5b12c7e92c}{theContext}()->\hyperlink{structvt_1_1ctx_1_1_context_a0d52c263ce8516546a67443d9a86fa5f}{getNode}();
  ...
  \textcolor{keywordtype}{int} val = 100;

  \textcolor{comment}{// Invoke the reduce!}
  proxy.\hyperlink{structvt_1_1objgroup_1_1proxy_1_1_proxy_ab8d4b9337c19d4ff0e758d03f3941b98}{allreduce}<&ReduceCol::reduceTarget, \hyperlink{namespacevt_1_1collective_a7a695a8e6ed8247f643918113b7bf881}{collective::PlusOp}>(val);
\}

\textcolor{keywordtype}{int} number\_of\_elements = 32;

\textcolor{keywordtype}{void} ReduceCol::reduceTarget(\textcolor{keywordtype}{int} value) \{
  fmt::print(\textcolor{stringliteral}{"collection reduce value=\{\}\(\backslash\)n"}, value);
  assert(number\_of\_elements * 100 == value);
...
\textcolor{comment}{   */}
  ...
  \textcolor{keywordflow}{if} (this\_node == 0) \{
    \textcolor{comment}{// Range of `number\_of\_elements` elements for the collection}
    \textcolor{keyword}{auto} range = \hyperlink{namespacevt_a5540efc78234273e1796fb003fe4d234}{vt::Index1D}(number\_of\_elements);
    ...
    \textcolor{comment}{// invoked on every element to the collection}
    proxy.\hyperlink{structvt_1_1objgroup_1_1proxy_1_1_proxy_a0b716ca776b1f06e0d7d45afbe9e5274}{broadcast}<&ReduceCol::reduceHandler>();
  \}
\}
\end{DoxyCodeInclude}
...
\textcolor{keyword}{struct }NodeObj \{
  ...
  \textcolor{keywordtype}{void} workFinishedHandler() \{ is\_finished\_ = \textcolor{keyword}{true}; \}
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keywordtype}{void} checkCompleteCB(\textcolor{keywordtype}{double} normRes) \{
    \textcolor{comment}{//}
    ...
    \textcolor{keywordflow}{if} (iter\_max\_reached or norm\_res\_done) \{
      ...
      objProxy\_.broadcast<&NodeObj::workFinishedHandler>();
  ...
  \textcolor{keywordtype}{void} doIteration() \{
    ...
    proxy.\hyperlink{structvt_1_1objgroup_1_1proxy_1_1_proxy_a10836524197347f63d5507f08d871e4f}{reduce}<&LinearPb1DJacobi::checkCompleteCB, \hyperlink{structvt_1_1collective_1_1reduce_1_1operators_1_1_max_op}{vt::collective::MaxOp}>(
      proxy[0], maxNorm
    );
  ...
  \textcolor{keywordtype}{void} doIter([[maybe\_unused]] BlankMsg *msg) \{
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keywordtype}{void} checkCompleteCB(\textcolor{keywordtype}{double} \textcolor{keyword}{const} normRes) \{
    \textcolor{comment}{//}
    \textcolor{comment}{// Only one object for the reduction will visit}
    \textcolor{comment}{// this function}
    \textcolor{comment}{//}
  ...
  \textcolor{keywordtype}{void} doIteration() \{
    ...
    \textcolor{keyword}{auto} proxy = this->getCollectionProxy();
    proxy.\hyperlink{structvt_1_1objgroup_1_1proxy_1_1_proxy_a10836524197347f63d5507f08d871e4f}{reduce}<&LinearPb2DJacobi::checkCompleteCB, \hyperlink{structvt_1_1collective_1_1reduce_1_1operators_1_1_max_op}{vt::collective::MaxOp}>(
      proxy(0,0), maxNorm
    );
  \}
...
\textcolor{keyword}{using} \hyperlink{namespacevt_1_1collective_a4c5bf7769ad4396573d6bcc85ec430a4}{ReduceMsg} = \hyperlink{structvt_1_1collective_1_1reduce_1_1operators_1_1_reduce_data_msg}{vt::collective::ReduceTMsg<double>};
...
\textcolor{keyword}{public}:
  ...
  \textcolor{keywordtype}{void} checkIntegral(\textcolor{keywordtype}{double} val) \{
    fmt::print(\textcolor{stringliteral}{" >> The integral over [0, 1] is \{\}\(\backslash\)n"}, val);
    fmt::print(
  ...
  \textcolor{keywordtype}{void} compute(InitMsg *msg) \{
    ...
    \textcolor{keyword}{auto} proxy = this->getCollectionProxy();
    proxy.\hyperlink{structvt_1_1objgroup_1_1proxy_1_1_proxy_a10836524197347f63d5507f08d871e4f}{reduce}<&Integration1D::checkIntegral, vt::collective::PlusOp>(
      proxy[0], quadsum
    );
  \}
