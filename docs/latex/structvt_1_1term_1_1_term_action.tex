...
\index{vt\+::term\+::\+Term\+Action@{vt\+::term\+::\+Term\+Action}!````~Term\+Action@{$\sim$\+Term\+Action}}
\index{````~Term\+Action@{$\sim$\+Term\+Action}!vt\+::term\+::\+Term\+Action@{vt\+::term\+::\+Term\+Action}}
\subsubsection{\texorpdfstring{$\sim$\+Term\+Action()}{~TermAction()}}
