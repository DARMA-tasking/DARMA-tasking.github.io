...
\index{vt\+::vrt\+::collection\+::\+Has\+Migrate@{vt\+::vrt\+::collection\+::\+Has\+Migrate}!````~Has\+Migrate@{$\sim$\+Has\+Migrate}}
\index{````~Has\+Migrate@{$\sim$\+Has\+Migrate}!vt\+::vrt\+::collection\+::\+Has\+Migrate@{vt\+::vrt\+::collection\+::\+Has\+Migrate}}
\subsubsection{\texorpdfstring{$\sim$\+Has\+Migrate()}{~HasMigrate()}}
