...
One may use {\ttfamily cmake} to build {\itshape checkpoint} once the dependencies are installed. The following are some options that can be provided to {\ttfamily cmake} to change the build configuration\+:
...
{\ttfamily checkpoint\+\_\+ubsan\+\_\+enabled} &0 &Enable undefined behavior sanitizer  \\\cline{1-3}
{\ttfamily checkpoint\+\_\+serialization\+\_\+error\+\_\+checking\+\_\+enabled($\ast$)} &0 &Enable extensive serialization error checking  \\\cline{1-3}
...
\begin{DoxyItemize}
\item note that if {\ttfamily checkpoint\+\_\+serialization\+\_\+error\+\_\+checking\+\_\+enabled} is not explicitly enabled or disabled, it will be {\bfseries{enabled}} for {\ttfamily Debug} and {\ttfamily Rel\+With\+Deb\+Info} builds and disabled for others.
...
{\ttfamily M\+A\+G\+I\+S\+T\+R\+A\+T\+E\+\_\+\+T\+E\+S\+T\+S\+\_\+\+E\+N\+A\+B\+L\+ED} &1 &Enable checkpoint tests  \\\cline{1-3}
{\ttfamily M\+A\+G\+I\+S\+T\+R\+A\+T\+E\+\_\+\+E\+X\+A\+M\+P\+L\+E\+S\+\_\+\+E\+N\+A\+B\+L\+ED} &1 &Enable checkpoint examples  \\\cline{1-3}
...
{\ttfamily M\+A\+G\+I\+S\+T\+R\+A\+T\+E\+\_\+\+M\+P\+I\+\_\+\+E\+N\+A\+B\+L\+ED} &1 &Enable checkpoint M\+PI for testing  \\\cline{1-3}
\end{longtabu}
...
\DoxyCodeLine{\#   MAGISTRATE\_TESTS=1                        \# Enable checkpoint tests}
\DoxyCodeLine{\#   MAGISTRATE\_EXAMPLES=1                     \# Enable checkpoint examples}
\DoxyCodeLine{\#   MAGISTRATE\_MPI=1                          \# Enable checkpoint MPI tests}
...
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+2.\+cc}\hypertarget{ckpt_learn_ex2_nonintrusive_ex2}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex2_nonintrusive_ex2}
...
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+3.\+cc}\hypertarget{ckpt_learn_ex3_nonintrusive_ex3}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex3_nonintrusive_ex3}
...
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+traversal.\+cc}\hypertarget{ckpt_learn_ex7_traversal_nonintrusive_ex7}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex7_traversal_nonintrusive_ex7}
...
\end{DoxyAttention}
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+1\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex1_nonintrusive_ex1}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex1_nonintrusive_ex1}
...
All Non-\/\+Intrusive serialize methods {\bfseries{M\+U\+ST}} be placed in the namespace of type which they serialize.
\end{DoxyAttention}
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+2\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex2_nonintrusive_ex2}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex2_nonintrusive_ex2}
...
All Non-\/\+Intrusive serialize methods {\bfseries{M\+U\+ST}} be placed in the namespace of type which they serialize.
\end{DoxyAttention}
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+3\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex3_nonintrusive_ex3}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex3_nonintrusive_ex3}
...
All Non-\/\+Intrusive serialize methods {\bfseries{M\+U\+ST}} be placed in the namespace of type which they serialize.
\end{DoxyAttention}
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+polymorphic\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex5_polymorphic_nonintrusive_ex5}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex5_polymorphic_nonintrusive_ex5}
...
All Non-\/\+Intrusive serialize methods {\bfseries{M\+U\+ST}} be placed in the namespace of type which they serialize.
\end{DoxyAttention}
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+polymorphic\+\_\+macro\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex6_polymorphic_macro_nonintrusive_ex6}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex6_polymorphic_macro_nonintrusive_ex6}
...
All Non-\/\+Intrusive serialize methods {\bfseries{M\+U\+ST}} be placed in the namespace of type which they serialize.
\end{DoxyAttention}
The full code for this {\itshape checkpoint} example can be found here\+: {\ttfamily examples/checkpoint\+\_\+example\+\_\+traversal\+\_\+nonintrusive.\+cc}\hypertarget{ckpt_learn_ex7_traversal_nonintrusive_ex7}{}\doxysubparagraph{Example source code\+:}\label{ckpt_learn_ex7_traversal_nonintrusive_ex7}
