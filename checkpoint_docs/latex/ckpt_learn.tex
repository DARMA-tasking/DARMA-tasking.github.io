...
To build {\itshape checkpoint}, one must obtain the following dependencies\+:\hypertarget{ckpt_learn_build_ckpt_required-deps}{}\doxysubsubsection{Required}\label{ckpt_learn_build_ckpt_required-deps}

\begin{DoxyItemize}
\item \href{https://github.com/DARMA-tasking/detector}{\texttt{ detector}}
\end{DoxyItemize}\hypertarget{ckpt_learn_build_ckpt_optional-deps}{}\doxysubsubsection{Optional}\label{ckpt_learn_build_ckpt_optional-deps}
